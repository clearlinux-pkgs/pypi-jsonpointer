...
Source0  : https://files.pythonhosted.org/packages/8f/5e/67d3ab449818b629a0ffe554bb7eb5c030a71f7af5d80fbf670d7ebe62bc/jsonpointer-2.4.tar.gz
...
%prep
%setup -q -n jsonpointer-2.4
cd %{_builddir}/jsonpointer-2.4
pushd ..
cp -a jsonpointer-2.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1687796472
